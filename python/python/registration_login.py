...
def register_product():
  ...
  m_price = main_price.get()
  discount_pri = discount_price.get()
  description_info = product_description.get()
...
def main_account_screen():
  ...
  t.Label(text="register product", bg='#a1ccd2', width="300",height='2').pack()
  t.Label(text="").pack()
  # t.Button(text="register product",height="2", width="30", command=register_product_page)
  t.Button(text="register product",height="2",width="30",command=register_product_page).pack()
